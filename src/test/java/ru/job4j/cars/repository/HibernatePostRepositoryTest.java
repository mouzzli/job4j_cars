...
class HibernatePostRepositoryTest {
    ...
    public void whenSaveThenFindById() {
        ...
        assertThat(postRepository.findById(post.getId()).get()).usingRecursiveComparison().isEqualTo(post);
    }
    ...
    public void whenSaveThenFindByBrand() {
        ...
        Post post = new Post(0, "testDescription", LocalDateTime.of(2022, 2, 1, 12, 50), BigDecimal.valueOf(1250000), user, car, new ArrayList<>());
        Post post2 = new Post(0, "testDescription", LocalDateTime.of(2021, 1, 1, 12, 50), BigDecimal.valueOf(1000000), user, car2, new ArrayList<>());
        postRepository.save(post);
    ...
    public void whenSaveThenFindByLastDay() {
        ...
        Post post2 = new Post(0, "testDescription", LocalDateTime.now().minus(3, ChronoUnit.DAYS), BigDecimal.valueOf(1000000), user, car2, new ArrayList<>());
        postRepository.save(post);
        postRepository.save(post2);
